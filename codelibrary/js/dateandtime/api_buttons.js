...
function sellfy_init_buttons() {
    ...
    function loadBtn() {
        ...
        if (id !== 'undefined' && button.className.indexOf('sellfy-buy-button-custom') === -1) {
            ...
            button.innerHTML = '<iframe name="sellfy_button_iframe" id="sellfy_button_iframe" style="width:170px; height:32px; overflow:hidden; margin: 0" src="" allowtransparency="true" frameborder="0"/>';
